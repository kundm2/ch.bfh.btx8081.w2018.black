...
public class CasePresenterImpl implements CasePresenter {

	private List<CurrentCaseListener> listeners = new ArrayList<>();
	private CaseService model = null;
	...
	public CasePresenterImpl(MainCaseView caseview, CaseService casemodel, CaseReportModel reportModel) {
		this.view = caseview;
